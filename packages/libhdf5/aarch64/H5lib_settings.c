...
char H5libhdf5_settings[]=
	...
	"             Installation point: /data/user/0/com.termux/files/xxxxx/usr\n"
	"\n"
	"Compiling Options:\n"
	"------------------\n"
	"                     Build Mode: Release\n"
	...
	"                        LDFLAGS: -Wl,--as-needed -L/data/user/0/com.termux/files/xxxxx/usr/lib\n"
	"                     H5_LDFLAGS: \n"
	"                     AM_LDFLAGS: \n"
	"                Extra libraries: m;dl\n"
	"                       Archiver: /data/user/0/com.termux/files/xxxxx/usr/bin/ar\n"
	"                         Ranlib: /data/user/0/com.termux/files/xxxxx/usr/bin/ranlib\n"
	"\n"
	"Languages:\n"
	"----------\n"
	"                              C: YES\n"
	"                     C Compiler: /data/user/0/com.termux/files/xxxxx/usr/bin/clang 15.0.7\n"
	"                       CPPFLAGS: \n"
	"                    H5_CPPFLAGS: \n"
	"                    AM_CPPFLAGS: \n"
	"                         CFLAGS:  -std=c99 -Oz -fstack-protector-strong -I/data/user/0/com.termux/files/xxxxx/usr/include\n"
	...
	"               Module Directory: /data/user/0/com.termux/files/xxxxx/files/home/termux.libhdf5.build/mod\n"
	"\n"
	"                            C++: ON\n"
	"                   C++ Compiler: /data/user/0/com.termux/files/xxxxx/usr/bin/clang++ 15.0.7\n"
	"                      C++ Flags:  -Oz -fstack-protector-strong -I/data/user/0/com.termux/files/xxxxx/usr/include\n"
